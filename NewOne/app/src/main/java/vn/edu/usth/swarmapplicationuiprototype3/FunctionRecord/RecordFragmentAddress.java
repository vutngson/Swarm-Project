...
public class RecordFragmentAddress extends Fragment implements View.OnClickListener, SeekBar.OnSeekBarChangeListener, MediaPlayer.OnCompletionListener {
    ...
    private static final String fileName = "Address";
    private  String filePath;
    private String folderID = "test";


    public RecordFragmentAddress() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.fragment_record_1, container, false);
        try {
        ...
        Button buttonHelp = (Button) rootView.findViewById(R.id.button_address_help);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.button_address_help:
                View view = getActivity().findViewById(R.id.button_address_help);
                Tooltip.make(getActivity(),
                        new Tooltip.Builder(101)
                                ...
                                .activateDelay(200)
                                .showDelay(200)
                                .text(getString(R.string.address_string_help))
