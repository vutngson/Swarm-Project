...
public class ScriptFragmentComment extends Fragment implements View.OnClickListener, SeekBar.OnSeekBarChangeListener, MediaPlayer.OnCompletionListener {
    ;
    ...
    private String fileName = "Comment";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.fragment_transcript_3, container, false);
        RelativeLayout relativeLayout = (RelativeLayout) rootView.findViewById(R.id.script3);
        ...
        editText = (EditText) rootView.findViewById(R.id.unique_survey_comment);
        editText.setText(ScriptUltis.ReadFile(folderID, fileName));
