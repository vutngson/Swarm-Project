...
public class RecordFragmentComment extends Fragment implements View.OnClickListener, SeekBar.OnSeekBarChangeListener, MediaPlayer.OnCompletionListener {
    ...
    private static final String fileName = "Comment";
    private  String filePath;
    private String folderID = "test";


    public RecordFragmentComment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.fragment_record_3, container, false);
        ...
        Button buttonHelp = (Button) rootView.findViewById(R.id.button_comment_help);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.button_comment_help:
                View view = getActivity().findViewById(R.id.button_comment_help);
                Tooltip.make(getActivity(),
                        new Tooltip.Builder(101)
                                ...
                                .activateDelay(200)
                                .showDelay(200)
                                .text(getString(R.string.comment_string_help))
