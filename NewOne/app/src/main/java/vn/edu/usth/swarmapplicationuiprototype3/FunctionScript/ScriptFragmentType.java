...
public class ScriptFragmentType extends Fragment implements View.OnClickListener, SeekBar.OnSeekBarChangeListener, MediaPlayer.OnCompletionListener {
    ;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.fragment_transcript_2, container, false);
        RelativeLayout relativeLayout = (RelativeLayout) rootView.findViewById(R.id.script2);
        ...
        editText = (EditText) rootView.findViewById(R.id.unique_survey_type);
        editText.setText(ScriptUltis.ReadFile(folderID, fileName));
